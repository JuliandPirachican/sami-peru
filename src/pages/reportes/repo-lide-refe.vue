  ...
  <div>
    <AppPlantilla>
      ...
      <template #contenido>
        <VRow>
          <VCol cols="12">
            <VCard title="Lideres Inscritas Referidas">
              <VCardText>
                <v-card>
                  <iframe id="iframe_option" ref="iframe_camb_clav" @load="modi_frame" src="https://intranet2col.azzorti.co/desarrollo/cgis/repo_refe_lide.php" frameborder="0"></iframe>
