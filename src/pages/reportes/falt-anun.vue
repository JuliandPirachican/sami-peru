        ...
        <VRow>
          <VCol cols="12">
            <VCard title="Reporte Faltante Anunciado">
              <VCardText>
                <v-card>
                  <iframe id="iframe_option" ref="iframe_camb_clav" @load="modi_frame" src="https://intranet2col.azzorti.co/desarrollo/cgis/falt_anuc_impo.php" frameborder="0"></iframe>
                </v-card>
              </VCardText>
            </VCard>
          </VCol>
