...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'reportes-comercial-lider-ganadoras-region': RouteRecordInfo<'reportes-comercial-lider-ganadoras-region', '/reportes/comercial/lider-ganadoras-region', Record<never, never>, Record<never, never>>,
    'reportes-comercial-lider-ganadoras-zona': RouteRecordInfo<'reportes-comercial-lider-ganadoras-zona', '/reportes/comercial/lider-ganadoras-zona', Record<never, never>, Record<never, never>>,
